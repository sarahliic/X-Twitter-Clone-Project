          ...
          <div className="flex justify-center items-center ">
            <div className="w-[80%] ">
              <p className="text-justify">
                Anyone has an alternative for Spark Mail? I used to love the app
                but its becoming completely unuseable. Every time I launch this
                app I need to wait for a 200mb update. Not to mention I dont use
                1% of those new features
              </p>
            </div>
          </div>
          <div>
